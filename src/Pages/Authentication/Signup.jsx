  ...
  return (
    <div>
            ...
            <form>
                ...
                <p class="subtitle">Already have an account? <a href="/login"> logn In</a></p>
                ...
                <div class="email-login">
                  ...
                  <input type="text" placeholder="Enter Full Name" name="ufname" required/>
                  <label for="email"> <b>Email</b></label>
                  <input type="text" placeholder="Enter Email" name="uname" required/>
                  <label for="name"> <b>Phone Number</b></label>
                  <input type="text" placeholder="Enter Phone No." name="ufname" required/>
